  ...
  <div class="login-page">
    <div class="login-container">
      <div class="login-header">
        <img src="/logo.svg" alt="Agent管理平台" class="logo" />
        <h1 class="title">Agent管理平台</h1>
        <p class="subtitle">AI 股票研究与资产管理</p>
      </div>
      ...
      <div class="login-footer">
        ...
        <p class="disclaimer">
          Agent管理平台是一个 AI 多智能体股票研究工具。平台分析结果由 AI 基于历史与公开市场数据生成，仅供研究参考，不作为交易指令。
        </p>
      </div>
    </div>
  </div>
